		...
		<div className="w-full min-h-screen relative overflow-hidden background text-white">
			<div className="w-full min-h-screen max-w-lg mx-auto px-6 flex flex-col justify-center">
				...
				<h1 className="text-2xl mb-8 font-medium">
					novo usuário<span className="text-fuchsia-600 text-3xl ml-1">.</span>
				</h1>
				<form className="flex flex-col gap-y-4" onSubmit={handleSubmit}>
					<Input Icon={UserIcon} name="name" label="nome" required />
					<div className="flex gap-4">
						<Input
							...
							required
						/>
						<Input Icon={UsersIcon} name="gender" label="gênero" required />
					</div>
					<Input
						Icon={MapPinIcon}
						name="cep"
